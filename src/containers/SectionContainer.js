...
const useStyles = makeStyles((theme) => ({
    container: {
        paddingTop: props => props.padding ? `${props.padding}px` : "50px",
        paddingBottom: props => props.padding ? `${props.padding}px` : "50px",
        minHeight: props => props.minHeight ? `${props.minHeight}px` : "630px"
    },
    titleContainer: {
